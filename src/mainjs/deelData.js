...
connection.end();
// 肺属金，属西方，在二十八星宿里东南西北有分别匹配青龙、白虎、朱雀、玄武。白虎局西方，五行属金，金的属性就是肃杀和收敛，对应的季节是秋季，糖尿病中医又叫消渴症，渴的原因就是津液的缺失，津液缺失的原因可以理解为肺的收敛作用减弱造成的，这也解释了为什么白虎加人参汤，可以治疗糖尿病，配方可以直接看出来：知母6两(93g)，人参3两(45g)，石膏一斤(248g)，炙甘草2两(30g)，粳米6合(120ml)，
// 知母6两(90g)，人参3两(45g) 君药--9的倍数
// 石膏一斤(248g)粳米6合(120ml-104g) 臣药--4的倍数
// 河图中西方金对应数字4和9匹配
...
// 桂枝三两（去皮）芍药三两 甘草二两（炙）生姜三两（切）大枣12枚（擘）
